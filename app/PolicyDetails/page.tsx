            ...
            <div className="lg:order-1 md:order-1 order-2 mt-[3px] ml-[2px]">
              ...
              <div className="bg-white border border-[#19a4e0] border-t-0 pt-[15px] pb-[30px] px-[15px] ">
                <p className="text-[#555555] mb-2 policy-para">
                  Policy documents will be sent to the email address provided.
                  If you need your documents posting to you, please let us know
                  by emailing{" "}
                  <a className="no-underline">contactus@tempcover.com</a>.
                </p>
              ...
              <p className="lg:block md:block hidden text-[#333] mt-7 text-[16px] unable-text">
                Unable to view your documentation? Download Adobe reader for
                free{" "}
              ...
              <div className="mt-8">
                <button className="btn btn-secondary px-3 py-1 home-button">HOME</button>
              </div>
            </div>
            ...
            <div className="lg:px-6 lg:order-2 md:order-2 order-1 detail-box">
              <div className="border bg-[#F2F2F2] flex text-[16px] flex-col  border-[#333] py-2 px-4">
                ...
                <div className=" text-[#333] ">
                  <strong className="font-bold">TO</strong> Monday, 9th June
                  2025 at 3:35 PM
                </div>
              </div>
              ...
              <div className="border bg-[#F2F2F2] flex gap-2 border-[#333] py-2 px-4">
                ...
                <div className="font-bold text-[#333]">Fully comprehensive cover
                </div>
              </div>
            </div>
          </div>
