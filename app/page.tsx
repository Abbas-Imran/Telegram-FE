...
export default function TempCoverValidation() {
  ...
  const [selectedDateOfPolicy, setSelectedDateOfPolicy] =
    React.useState<Date | null>(null);
  ...
  const handleLogin = () => {
    ...
    if (t) {
      ...
      if (
        decoded?.surname == surname &&
        decoded?.dob == formatDate(selectedDateOfBirth) &&
        decoded?.startDate == formatDate(selectedDateOfPolicy)
      ) {
                  ...
                  <div className="lg:w-[58%]">
                    <div className="flex">
                      ...
                      {surname != "" ? (
                        <div className="flex w-[30%] justify-center items-center">
                          <Image
                            src={"Approve-removebg-preview.png"}
                            className="w-[40px] h-[40px]"
                            width={50}
                            height={5}
                            alt=""
                    ...
                    {isSurnameError ? (
                      <span className="text-sm text-[#E92A1B]">
                        Surname is not supplied
                      </span>
                    ) : null}
                  </div>
                </div>
                  ...
                  <div className="relative lg:w-[58%]">
                    <div className="flex ">
                      <input
                        ...
                        className={`form-control ${
                          isPolicyError ? "!border-[#E92A1B] " : ""
                        }`}
                        value={
                          selectedDateOfPolicy
                            ? formatDate(selectedDateOfPolicy)
                            : ""
                        }
